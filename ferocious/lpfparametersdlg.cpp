    ...
    nyquistFrequency(0.0)
{
    ...
    connect(ui->cutoffSpinBox, static_cast<void(QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [this](double val) {
    ...
    connect(ui->transitionSpinBox, static_cast<void(QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [this](double val) {
       if(nyquistFrequency != 0.0) {
           QString suffix = " %   (" + QString::number(nyquistFrequency * 0.01 * val,'f',2) + " Hz)";
